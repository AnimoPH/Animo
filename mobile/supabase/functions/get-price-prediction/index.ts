...
//   supabase functions deploy get-price-prediction
//
...
//
// This is the endpoint the mobile app calls to show "Tinantyang Presyo".
// For the LGU "is the market weird right now" dashboard signal, see the
// separate get-market-status function (same data-fetch logic, calls
// /market-status instead).
